...
const dict = {
  hr: {
    ...
    hero: {
      ...
      sub: "Nezavisni smo konzultanti: procjenjujemo isplativost, projektiramo rješenje, strukturiramo EU i HR poticaje — i povezujemo vas s provjerenim hrvatskim integratorom koji će ga izgraditi.",
    ...
    pillars: {
      ...
      items: [
        ...
        { n: "03", t: "Provjereni integratori", d: "Projektiramo sustav, raspisujemo natječaj među provjerenim hrvatskim integratorima i nadziremo izvedbu do preuzimanja. Vi dobivate najbolju cijenu — bez rizika." },
      ],
    },
    process: {
      code: "S.02 — Proces",
    ...
    team: {
      ...
      members: [
        { init: "J", name: "Jonathan Soucie", img: "/team/jon.jpg", role: "Inženjering i projektiranje", bio: "Kanadski inženjer robotike s praktičnim iskustvom u ugradbenim sustavima i projektiranju robotskih ćelija. Vodi procjene, dizajn sustava i simulacije." },
        ...
        { init: "N", name: "Nicola Sartori", img: "/team/nick.jpeg", role: "Strategija i poslovni razvoj", bio: "Diplomirani stručnjak međunarodnog poslovanja s iskustvom u strateškom marketingu, istraživanju tržišta i pozicioniranju brenda u Italiji i Sjevernoj Americi. Vodi kontakt s klijentima, partnerstva i komunikacije." },
      ],
    },
    faq: {
      ...
      items: [
        ...
        { q: "Tko gradi sustav?", a: "Provjereni hrvatski integratori. Mi projektiramo rješenje, raspisujemo natječaj među njima i nadziremo izvedbu do preuzimanja. Vi dobivate konkurentnu cijenu i jednog odgovornog partnera — nas." },
  ...
  it: {
    ...
    hero: {
      eyebrow: "Consulenza indipendente per l'automazione · Zagabria",
      title_a: "Automatizza in modo intelligente.",
      title_b: "Con i finanziamenti.",
      sub: "Siamo consulenti indipendenti: valutiamo il ritorno dell'investimento, progettiamo la soluzione, strutturiamo gli incentivi UE e croati — e vi mettiamo in contatto con un integratore croato qualificato che la realizzerà.",
    ...
    pillars: {
      ...
      items: [
        ...
        { n: "03", t: "Integratori qualificati", d: "Progettiamo il sistema, lo mettiamo a gara tra integratori croati qualificati e supervisioniamo la realizzazione fino al collaudo. Ottenete il miglior prezzo — senza rischi." },
      ],
    },
    process: {
      code: "S.02 — Processo",
    ...
    team: {
      ...
      members: [
        { init: "J", name: "Jonathan Soucie", img: "/team/jon.jpg", role: "Ingegneria e progettazione", bio: "Ingegnere robotico canadese con esperienza pratica in sistemi embedded e progettazione di celle robotizzate. Guida le valutazioni, la progettazione dei sistemi e le simulazioni." },
        ...
        { init: "N", name: "Nicola Sartori", img: "/team/nick.jpeg", role: "Strategia e sviluppo commerciale", bio: "Laureato in business internazionale con esperienza nel marketing strategico. Guida i rapporti con i clienti, le partnership e la comunicazione." },
      ],
    },
    faq: {
      code: "S.05 — FAQ",
      ...
      items: [
        ...
        { q: "Chi costruisce il sistema?", a: "Integratori croati qualificati. Progettiamo la soluzione, la mettiamo a gara tra di loro e supervisioniamo la realizzazione fino al collaudo. Ottenete un prezzo competitivo e un unico partner responsabile — noi." },
        ...
        { q: "Quanto dura un progetto?", a: "Analisi delle opportunità: 1 giorno. Audit: 1–2 settimane. Progettazione e gara: 4–8 settimane. Realizzazione e messa in servizio: dipende dall'integratore, in genere 8–16 settimane. La maggior parte dell'ingegneria avviene offline, in simulazione, quindi l'impatto sulla vostra produzione è minimo." },
